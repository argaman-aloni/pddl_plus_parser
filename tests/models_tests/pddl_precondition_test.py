...
from tests.models_tests.consts import (
    ...
    HARD_TEST_NUMERIC_DOMAIN,
    DOMAIN_TO_TEST_INEQUALITY_REMOVAL,
    DOMAIN_TO_TEST_BOTH_TYPES_OF_INEQUALITY,
)
...
def test_add_condition_adds_a_single_predicate_correctly(
...
def test_eq_returns_true_for_unnested_preconditions_when_they_contain_a_predicate_and_a_numeric_expression(
    ...
    test_predicate = domain.predicates["on_board"]
    numeric_condition_expression = [
        ">=",
        ["fuel", "?s"],
        ["slew_time", "?d_new", "?d_prev"],
    ]

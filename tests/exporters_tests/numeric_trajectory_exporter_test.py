...
from .consts import (
    TEST_DISCRETE_DOMAIN_PATH,
    TEST_DISCRETE_PROBLEM_PATH,
    TEST_DISCRETE_PLAN_PATH,
    TEST_NUMERIC_DOMAIN_PATH,
    TEST_NUMERIC_PROBLEM_PATH,
    TEST_NUMERIC_PLAN_PATH,
    TEST_FAULTY_NUMERIC_PLAN_PATH,
    TEST_DISCRETE_TRAJECTORY_FILE_PATH,
    TEST_NUMERIC_TRAJECTORY_FILE_PATH,
    TEST_CONDITIONAL_DOMAIN_PATH,
    TEST_CONDITIONAL_PROBLEM_PATH,
    TEST_CONDITIONAL_PLAN_PATH,
    TEST_MINECRAFT_DOMAIN_PATH,
    TEST_MINECRAFT_PROBLEM_PATH,
    TEST_MINECRAFT_PLAN_PATH,
    TEST_MICONIC_DOMAIN_PATH,
    TEST_MICONIC_PROBLEM_PATH,
    TEST_MICONIC_PLAN_PATH,
)
...
def create_state_from_predicate_components(components: List[List[str]], problem_parser: ProblemParser) -> State:
...
def test_create_single_triplet_with_single_state_and_single_call_creates_next_state_correctly(
    discrete_trajectory_exporter: TrajectoryExporter, discrete_problem_parser: ProblemParser, discrete_problem: Problem
):
    test_simple_state_components = [
        ["lift-at", "slow2-0", "n17"],
        ["above", "n16", "n17"],

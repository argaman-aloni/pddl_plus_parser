...
class ConditionalEffect:
    ...
    def __str__(self):
        ...
        negative_conditionals = "\n\t".join([f"(not {negative_cond.untyped_representation})" for negative_cond in self.negative_conditions])
        ...
        delete_effect = "\n\t".join([f"(not {negative_effect.untyped_representation})" for negative_effect in self.delete_effects])
